...
export function InfiniteMovingCardsContainer() {
  return (
    <div className="h-[32rem] rounded-md flex flex-col antialiased bg-black dark:bg-white dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
